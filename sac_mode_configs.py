...
def thesis(
    ...
    if poisson_rates is not None:
        params["poisson_mode"] = False
        params["poissarma_mode"] = True
        params["poissarma_ar_params"] = np.array([0.9, -0.1])
        params["poissarma_ma_params"] = np.array([0.0])
        params["poissarma_innov_scale"] = 1.0
        params["poissarma_base_scale"] = 0.0
        ...
        params["synprops"]["E"]["tau1"] = 1.2
        params["synprops"]["PLEX"]["tau1"] = 1.2
        params["synprops"]["I"]["tau1"] = 0.6
        params["synprops"]["NMDA"]["tau1"] = 1.2

        params["synprops"]["E"]["tau2"] = 3.0
        params["synprops"]["PLEX"]["tau2"] = 3.0
        params["synprops"]["I"]["tau2"] = 6.0
        params["synprops"]["NMDA"]["tau2"] = 6.0

        params["synprops"]["E"]["delay"] = 0.0

        base_w = 0.000313
        params["synprops"]["E"]["weight"] = base_w * 0.45
        params["synprops"]["I"]["weight"] = base_w * 1.44
        params["synprops"]["NMDA"]["weight"] = base_w * 0.45
        params["synprops"]["PLEX"]["weight"] = base_w * 0.45
